...
const TopChartCard = ({ song, i, isPlaying, activeSong, handlePauseClick, handlePlayClick }) => (
  <div className="flex flex-row w-full items-center hover:bg-[#4c426e] 
...
const TopPlay = () => {
  ...
  return (
    ...
    flex-1 xl:max-w-[500px] max-x-full flex flex-col">
      ...
      <div className="w-full flex flex-col mt-8">
        ...
        >
          {topPlays?.map((song, i) => (
            ...
            >
              <Link to={`/artists/${song?.artists[0].adamid}`}>
                <img src={song?.images.background} alt="name" className="w-full rounded-xl object-cover" />
              </Link>
            </SwiperSlide>
          ))}
        </Swiper>
